          ...
          <div className="col-lg-6 col-md-6">
            ...
            <ul className="list-group ">
              <li>
                ...
                might arrise during your trip.
              </li>
              <li>
                <span>Pick your dream car</span> - Countless makers and models
                to chosen from.
              </li>
              <li>
                <span>Rent and Earn</span> - Rent your AMAZING car to others and
                earn money while doing it
              </li>
              <li>
                <span>Drive with Confidence</span> - comes with standard
